...
if(isset($PostID) && isset($_POST['team_b_setting_save_action'])) {
			...
			$design = apply_filters( "sanitize_option_design", $_POST['design'], 'design', '1' );
			$custom_css            = sanitize_textarea_field($_POST['custom_css']);
			$team_car_dots_show_hide 		= apply_filters("sanitize_option_dots", $_POST['team_car_dots_show_hide'],'team_car_dots_show_hide', 'yes' );
